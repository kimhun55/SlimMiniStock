...
--
-- Host: localhost:3306
-- Generation Time: Apr 22, 2020 at 11:06 AM
...
--
-- Database: `stockrestdb`
--
CREATE DATABASE IF NOT EXISTS `stockrestdb` DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci;
USE `stockrestdb`;
...
(59, 'The new samsung galaxy phone', 'Samsung A30', '8566565565656', 10, '12500.00', NULL, 'noimg.jpg', 'electronic', 1),
(60, 'The new samsung galaxy phone', 'Samsung A30', '8566565565656', 10, '12500.00', NULL, 'noimg.jpg', 'electronic', 1);
...
INSERT INTO `users` (`id`, `username`, `password`, `fullname`, `img_profile`, `status`, `email`) VALUES
(1, 'user', '7c4a8d09ca3762af61e59520943dc26494f8941b', 'Guest for test', 'guest.jpg', 1, 'kimhun55@gmail.com'),
